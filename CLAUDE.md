...
- **`sign-opposition-axis`** — **CANONICAL** (first-composition / spatial). 3 residencies: R=φ dodec 5-fold axis × pentagon-face antipodal-pair × icosidodec-midpt cluster = 6 zodiac sign-opposition pairs. Modality = instance-parameter. OQ-SOLID-12 council 2026-05-14. [added to this file 2026-06-15 — was missing.]
- **`coupling-point`** — **CANONICAL** (primitive / spatial frame-intersection; `enumerated_cardinality` ∈ {None,2,7,12}). 6 residencies: rising-sign + lunar-nodes + Lawvere-origin + branches + ico-edge-grandchildren + Persephone-position. FINDINGS_020/022/024/025. [added to this file 2026-06-15 — was missing.]
...
- **COUNT (reconciled 2026-06-15): 7 CANONICAL + 1 candidate** (canon §30 line 14 authoritative). This file previously listed only 5 — was stale pre-`sign-opposition-axis` (2026-05-14) and `coupling-point` (2026-05-17) graduations.

**§30 schema** now has added columns: `functional_tier` (primitive / first-composition / second-composition / system), `compositional_axis` (spatial / temporal / mixed / N/A), and `enumerated_cardinality` (added 2026-05-17). The 7 canonical entries: 2 primitive-spatial (planet-aspect-activate, coupling-point) + 5 first-composition (sign-opposition-axis + polarity-define + triangle-aspect-activate spatial; cyclic-syzygy-activate + cyclic-sign-ingress-activate temporal).
